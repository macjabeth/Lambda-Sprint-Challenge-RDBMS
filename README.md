...
SQL is a language which communicates with RDBMS like Sqlite3 or PostgresQL.

**2. Why do tables need a `primary key`?**

Because they uniquely identify each row in the table.
...
We need to create a separate table that reference the PKs on the other tables (via FKs).
...
Project
  ID.Unique  Name  Description  Completed
